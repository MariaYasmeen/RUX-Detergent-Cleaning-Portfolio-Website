...
const FAQs = () => {
  ...
  return (
    <div className="faqs-container  d-flex flex-column justify-content-center align-items-center min-vh-100" >
      ...
      <div className="accordion w-80 container faqs-ctr">
        {faqs.map((faq, index) => (
          <div key={index} className="accordion-item container">
            <div
              className="accordion-header d-flex justify-content-between align-items-center p-1 border-bottom"
            ...
            <div ref={(el) => (answerRefs.current[index] = el)} className="accordion-body p-2">
